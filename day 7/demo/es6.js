...
// let myLet = 5 ;
// let myLet = "sara" // SyntaxError: Identifier 'myLet' has already been declared
// myLet = 55
// console.log(myLet);
...
//         console.log("داخل if - functionVar:", functionVar); //   "في بداية الدالة"
//         console.log("داخل if - anotherVar:", anotherVar); //  "متغير جديد جوّا if"
//     }
...
// }
// console.log(item); // ReferenceError — item مش موجود برّا الـ loop (block scope)
// arr.unshift(55);
...
// var obj1=JSON.stringify([{name :"ali"}]);
// console.log(typeof obj1);
// localStorage.setItem('products',obj1) ;
//  let objCome = JSON.parse(localStorage.getItem('products')) ;
//  console.log(typeof objCome);
