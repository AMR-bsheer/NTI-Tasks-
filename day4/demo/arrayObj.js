...
// ========== 6. Dot (.) vs Bracket [] ==========
// Use [] when the key has special characters (like -) and unknown prob (dynamic prob )
// var student = {
//     "student-name": "Ahmed", // snak case user-name  , userName camel Case , UserName >> PascalCase
//     age: 22
// };
...
// console.log(company.location['street-details'].boxNo.no);
...
// ========== 1. Creating an Array ==========
// var fruits = ["Apple", "Banana", "Orange", "Banana", "OGrapes"];
// console.log(fruits);
...
// var upperCaseFruits = fruits.map(function (val , index){
...
// var removed = letters.splice(2, 2,3,5);
