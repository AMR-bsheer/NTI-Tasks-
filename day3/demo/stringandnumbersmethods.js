...
// ========== 6. Extracting a part of the String using slice (firstIndex , lastIndex) ==========
// var sliced = "abcdefgggggggggggggggggggggggg".slice(5, 15);  
...
// var sentenceFromArray = wordArray.join(" "); // .split(" ")
...
// var num3 = parseFloat(floatStr);  // return 456.78 not NaN because parseFloat can parse until it encounters a non-numeric character
// console.log(num3); 

// ========== 2. Checking if a value is NaN (Not a Number) ==========
// var notANumber = "abc";
// console.log(isNaN(notANumber)); // false then the param is number
...
// var minimumNumber = 10;
// var maximumNumber = 30;
